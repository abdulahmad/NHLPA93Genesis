...
const assets = [
    ...
    // { name: 'Walesh.pal', folder: 'Graphics/Pals', start: 0x680, end: 0x6A0 },
    // { name: 'Walesv.pal', folder: 'Graphics/Pals', start: 0x6A0, end: 0x6C0 },
    // { name: 'Campbellh.pal', folder: 'Graphics/Pals', start: 0x38A, end: 0x3AA },
    // { name: 'Campbellv.pal', folder: 'Graphics/Pals', start: 0x3AA, end: 0x3CA },
    { name: 'Walesh.pal', folder: 'Graphics/Pals', start: 0x388, end: 0x3A8 }, // ASE
    { name: 'Walesv.pal', folder: 'Graphics/Pals', start: 0x3A8, end: 0x3C8 },
    { name: 'Campbellh.pal', folder: 'Graphics/Pals', start: 0x624, end: 0x644 }, // ASW
    { name: 'Campbellv.pal', folder: 'Graphics/Pals', start: 0x644, end: 0x664 },
    { name: 'Bruinsh.pal', folder: 'Graphics/Pals', start: 0x8C4, end: 0x8E4 },
    { name: 'Bruinsv.pal', folder: 'Graphics/Pals', start: 0x8E4, end: 0x904 },
    { name: 'sabresh.pal', folder: 'Graphics/Pals', start: 0xB7C, end: 0xB9C },
    { name: 'sabresv.pal', folder: 'Graphics/Pals', start: 0xB9C, end: 0xBBC },
    { name: 'flamesh.pal', folder: 'Graphics/Pals', start: 0xE3E, end: 0xE5E },
    { name: 'flamesv.pal', folder: 'Graphics/Pals', start: 0xE5E, end: 0xE7E },
    { name: 'blackhawksh.pal', folder: 'Graphics/Pals', start: 0x10E4, end: 0x1104 },
    { name: 'blackhawksv.pal', folder: 'Graphics/Pals', start: 0x1104, end: 0x1124 },
    { name: 'Redwingsh.pal', folder: 'Graphics/Pals', start: 0x13A4, end: 0x13C4 },
    { name: 'Redwingsv.pal', folder: 'Graphics/Pals', start: 0x13C4, end: 0x13E4 },
    { name: 'oilersh.pal', folder: 'Graphics/Pals', start: 0x165C, end: 0x167C },
    ...
    { name: 'devilsv.pal', folder: 'Graphics/Pals', start: 0x26CE, end: 0x26EE },
    { name: 'rangersh.pal', folder: 'Graphics/Pals', start: 0x2966, end: 0x2986 },
    { name: 'rangersv.pal', folder: 'Graphics/Pals', start: 0x2986, end: 0x29A6 },
    { name: 'otth.pal', folder: 'Graphics/Pals', start: 0x2C2E, end: 0x2C4E }, // OTT
    { name: 'ottv.pal', folder: 'Graphics/Pals', start: 0x2C4E, end: 0x2C6E },
    { name: 'flyersh.pal', folder: 'Graphics/Pals', start: 0x2E4C, end: 0x2E6C },
    { name: 'flyersv.pal', folder: 'Graphics/Pals', start: 0x2E6C, end: 0x2E8C },
    { name: 'penguinsh.pal', folder: 'Graphics/Pals', start: 0x3108, end: 0x3128 },
    { name: 'penguinsv.pal', folder: 'Graphics/Pals', start: 0x3128, end: 0x3148 },
    { name: 'nordiquesh.pal', folder: 'Graphics/Pals', start: 0x33AC, end: 0x33CC },
    { name: 'nordiquesv.pal', folder: 'Graphics/Pals', start: 0x33CC, end: 0x33EC },
    { name: 'Sharksh.pal', folder: 'Graphics/Pals', start: 0x3686, end: 0x36A6 },
    { name: 'Sharksv.pal', folder: 'Graphics/Pals', start: 0x36A6, end: 0x36C6 },
    { name: 'bluesh.pal', folder: 'Graphics/Pals', start: 0x3940, end: 0x3960 },
    { name: 'bluesv.pal', folder: 'Graphics/Pals', start: 0x3960, end: 0x3980 },
    { name: 'tbh.pal', folder: 'Graphics/Pals', start: 0x3BF6, end: 0x3C16 }, // TB
    { name: 'tbv.pal', folder: 'Graphics/Pals', start: 0x3C16, end: 0x3C36 },
    { name: 'mapleleafsh.pal', folder: 'Graphics/Pals', start: 0x3E34, end: 0x3E54 },
    { name: 'mapleleafsv.pal', folder: 'Graphics/Pals', start: 0x3E54, end: 0x3E74 },
    { name: 'canucksh.pal', folder: 'Graphics/Pals', start: 0x40EE, end: 0x410E },
    { name: 'canucksv.pal', folder: 'Graphics/Pals', start: 0x410E, end: 0x412E },
    { name: 'jetsh.pal', folder: 'Graphics/Pals', start: 0x43A8, end: 0x43C8 },
    { name: 'jetsv.pal', folder: 'Graphics/Pals', start: 0x43C8, end: 0x43E8 },
    { name: 'capitalsh.pal', folder: 'Graphics/Pals', start: 0x4666, end: 0x4686 },
    { name: 'capitalsv.pal', folder: 'Graphics/Pals', start: 0x4686, end: 0x46A6 },
    // START OF DATA FILES
